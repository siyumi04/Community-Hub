            ...
            <form onSubmit={handleAdminSubmit} className="admin-form">
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  />
                  {adminErrors.firstName && adminTouched.firstName && (
                    <p className="field-error">{adminErrors.firstName}</p>
                  )}
                </div>
                <div className="form-group">
                  <label>Last Name</label>
                  ...
                  />
                  {adminErrors.lastName && adminTouched.lastName && (
                    <p className="field-error">{adminErrors.lastName}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    name="itNumber"
                    placeholder="IT24CS001"
                    value={adminForm.itNumber}
                    onChange={handleAdminChange}
                    onBlur={handleAdminBlur}
                    className={adminErrors.itNumber && adminTouched.itNumber ? 'input-error' : ''}
                  />
                  {adminErrors.itNumber && adminTouched.itNumber && (
                    <p className="field-error">{adminErrors.itNumber}</p>
                  )}
                </div>
                <div className="form-group">
                  <label>Email Address</label>
                  ...
                  {adminErrors.email && adminTouched.email && (
                    <p className="field-error">{adminErrors.email}</p>
                  )}
                </div>
              </div>
              ...
              {/* Dashboard Name */}
              <div className="form-group">
                <label>Admin Dashboard Name</label>
                <input
                  type="text"
                  name="dashboardName"
                ...
                />
                {adminErrors.dashboardName && adminTouched.dashboardName && (
                  <p className="field-error">{adminErrors.dashboardName}</p>
                )}
                <small className="field-hint">3-30 characters (letters, numbers, hyphens, underscores)</small>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <small className="field-hint">Min 8 chars: uppercase, lowercase, number</small>
                </div>
                <div className="form-group">
                  <label>Confirm Password</label>
                  <input
                  ...
                  />
                  {adminErrors.confirmPassword && adminTouched.confirmPassword && (
                    <p className="field-error">{adminErrors.confirmPassword}</p>
                  )}
                </div>
              </div>
              ...
              >
                {adminLoading ? 'Creating Admin Account...' : 'Create Admin Account'}
              </button>
            </form>

            <div className="tab-footer">
              <p>Already have an admin account? <Link to="/login" className="login-link">Login here</Link></p>
            </div>
          </div>
        )}
      </div>
